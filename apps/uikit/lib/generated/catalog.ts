...
export type BaseComponentCategory =
  | "accordion"
  | "alert-dialog"
  | "aspect-ratio"
  | "avatar"
...
export type RadixComponentCategory =
  | "accordion"
  | "alert-dialog"
  | "aspect-ratio"
  | "avatar"
...
export type EnterpriseBlockName =
  | "alert"
  | "autocomplete"
  | "badge"
  | "data-grid"
...
export const EXAMPLE_CATEGORIES = [
  ...
  },
  {
    ...
    title: "Data Grid",
    description:
      "A powerful TanStack Table v9 data grid with sorting, filtering, pagination, footer rows, drag-and-drop, virtualization, infinite scroll, row pinning, and tree rows.",
    order: 20,
    isBlock: true,
  },
  {
  ...
  },
  {
    ...
    description:
      "A headless-first event calendar with month, week, day, N-day and agenda views, drag-and-drop scheduling, recurring events, time zones, and an external CRUD contract.",
    order: 26,
    isBlock: true,
  },
  {
  ...
  },
  {
    ...
    title: "Gantt",
    description:
      "A headless-first gantt with split tree and timeline panes, day to year scales, zoom, drag and resize scheduling, progress, summary rollups, and an external CRUD contract.",
    order: 31,
    isBlock: true,
  },
  {
  ...
  },
  {
    ...
    title: "Icon Stack",
    description:
      "Shadcn Icon Stack for isometric icons, layered icon illustrations, and empty-state visuals.",
    order: 33,
    isBlock: true,
  },
  {
    ...
    title: "Icon Tile",
    description:
      "Shadcn Icon Tile that wraps an icon in a consistent square surface for list rows, feature cards, and empty states.",
    order: 34,
    isBlock: true,
  },
  {
