  ...
  switch (tone) {
    case "backlog":
      return (
        <CircleDotIcon
          className={cn(
            "size-4 shrink-0 text-muted-foreground/70! **:text-muted-foreground/70!",
            className
          )}
        />
      )
    case "planned":
      return (
        <CircleIcon
          className={cn(
            "size-4 shrink-0 text-foreground/70! [&_*]:text-foreground/70!",
            className
          )}
        />
      )
    ...
    case "cancelled":
      return (
        <CircleXIcon
          className={cn(
            "size-4 shrink-0 text-muted-foreground! [&_*]:text-muted-foreground!",
            className
          )}
        />
      )
