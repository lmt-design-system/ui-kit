...
export default function Pattern() {
  return (
    <div className="flex items-center gap-3">
      ...
      <Avatar className="size-8 ring-2 ring-destructive ring-offset-2 ring-offset-background">
        <AvatarImage
      ...
      <Avatar className="size-8 ring-2 ring-violet-500 ring-offset-2 ring-offset-background">
        <AvatarImage
      ...
      <Avatar className="size-8 ring-2 ring-yellow-500 ring-offset-2 ring-offset-background">
        <AvatarImage
