...
const inputVariants = cva(
  "flex w-full border border-input bg-transparent text-sm text-foreground transition-colors outline-none placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:bg-input/30 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 style-vega:rounded-md style-nova:rounded-lg style-lyra:rounded-none style-maia:rounded-4xl style-mira:rounded-md style-luma:rounded-3xl style-sera:rounded-none style-rhea:rounded-2xl [[readonly]]:cursor-not-allowed [[readonly]]:bg-muted/80",
  {
    variants: {
      size: {
  ...
  return (
    <AutocompletePrimitive.Item
      ...
      className={cn(
        ...
        "style-vega:data-highlighted:before:rounded-sm style-nova:data-highlighted:before:rounded-md style-lyra:data-highlighted:before:rounded-none style-maia:data-highlighted:before:rounded-xl style-mira:data-highlighted:before:rounded-md style-luma:data-highlighted:before:rounded-2xl style-sera:data-highlighted:before:rounded-none style-rhea:data-highlighted:before:rounded-2xl",
        "([class*='size-'])]:size-4 ([class*='size-'])]:size-4 ([class*='size-'])]:size-4 ([class*='size-'])]:size-3.5 ([class*='size-'])]:size-4 ([class*='size-'])]:size-3.5 relative flex cursor-default items-center px-1.5 py-1 text-sm outline-hidden transition-colors select-none data-highlighted:relative data-highlighted:z-0 data-highlighted:before:absolute data-highlighted:before:inset-x-0 data-highlighted:before:inset-y-0 data-highlighted:before:z-[-1] data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([role=img]):not([class*=text-])]:opacity-60",
        className
      )}
      {...props}
    />
      ...
      >
        <div className="relative flex max-h-full">
          <AutocompletePrimitive.Popup
            ...
            className={cn(
              "flex max-h-[min(var(--available-height),24rem)] w-(--anchor-width) max-w-(--available-width) origin-(--transform-origin) scroll-pt-2 scroll-pb-2 flex-col overscroll-contain bg-popover py-0.5 text-popover-foreground shadow-md ring-1 ring-foreground/10 transition-[scale,opacity] has-data-starting-style:scale-98 has-data-starting-style:opacity-0 has-data-[side=none]:scale-100 has-data-[side=none]:transition-none style-vega:rounded-md style-nova:rounded-lg style-lyra:rounded-none style-maia:rounded-2xl style-mira:rounded-lg style-luma:rounded-3xl style-sera:rounded-none style-rhea:rounded-2xl",
              className
            )}
            {...props}
          >
