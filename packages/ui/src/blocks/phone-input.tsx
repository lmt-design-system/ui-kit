      ...
      <ComboboxTrigger
        render={
          <Button
            ...
            size={variant}
            className={cn(
              "flex gap-1 rounded-e-none border-e-0 px-2.5 py-0 leading-none hover:bg-transparent focus:z-10 data-pressed:bg-transparent style-vega:rounded-s-md style-nova:rounded-s-lg style-lyra:rounded-s-none style-maia:rounded-s-4xl style-mira:rounded-s-md style-luma:rounded-s-3xl style-sera:rounded-s-none style-rhea:rounded-s-2xl",
              disabled && "opacity-50"
            )}
            disabled={disabled}
          >
