...
function DataGridColumnHeaderInner<TData extends object, TValue>({
  ...
  const headerButtonClassName = cn(
    "h-6 px-2 font-normal text-secondary-foreground/80 hover:bg-secondary hover:text-foreground data-[state=open]:bg-secondary data-[state=open]:text-foreground style-vega:rounded-md style-nova:rounded-lg style-lyra:rounded-none style-maia:rounded-full style-mira:rounded-md style-luma:rounded-full style-sera:rounded-none style-rhea:rounded-full",
    className
  )
      ...
      <div className="-ms-2 flex h-full items-center justify-between gap-1.5">
        ...
        {props.tableLayout?.columnsPinnable && canPin && isPinned && (
          <Button
            size="icon-sm"
            variant="ghost"
            className="-me-1 size-7 style-vega:rounded-md style-nova:rounded-lg style-lyra:rounded-none style-maia:rounded-full style-mira:rounded-md style-luma:rounded-full style-sera:rounded-none style-rhea:rounded-full"
