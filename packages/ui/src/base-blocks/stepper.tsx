...
function StepperTrigger({
  ...
  const defaultProps = {
    ...
    className: cn(
      "relative inline-flex cursor-pointer items-center outline-none focus-visible:z-10 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-60",
      "gap-2.5 rounded-full",
      "pointer-coarse:after:absolute pointer-coarse:after:inset-0 pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11",
      className
    ),
