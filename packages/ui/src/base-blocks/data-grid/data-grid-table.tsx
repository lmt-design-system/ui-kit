  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute top-0 left-0 -translate-x-1/2 bg-primary shadow-xs style-vega:rounded-b-sm style-nova:rounded-b-sm style-lyra:rounded-b-none style-maia:rounded-b-md style-mira:rounded-b-sm style-luma:rounded-b-lg style-sera:rounded-b-none style-rhea:rounded-b-lg"
        style={{ width: 5 }}
      />
    </div>
  )
    ...
    <tbody
      ...
      className={cn(
        props.tableLayout?.rowRounded &&
          "style-vega:[&_td:first-child]:rounded-l-lg style-nova:[&_td:first-child]:rounded-l-lg style-lyra:[&_td:first-child]:rounded-l-none style-maia:[&_td:first-child]:rounded-l-2xl style-mira:[&_td:first-child]:rounded-l-lg style-luma:[&_td:first-child]:rounded-l-3xl style-sera:[&_td:first-child]:rounded-l-none style-rhea:[&_td:first-child]:rounded-l-2xl",
        props.tableLayout?.rowRounded &&
          "style-vega:[&_td:last-child]:rounded-r-lg style-nova:[&_td:last-child]:rounded-r-lg style-lyra:[&_td:last-child]:rounded-r-none style-maia:[&_td:last-child]:rounded-r-2xl style-mira:[&_td:last-child]:rounded-r-lg style-luma:[&_td:last-child]:rounded-r-3xl style-sera:[&_td:last-child]:rounded-r-none style-rhea:[&_td:last-child]:rounded-r-2xl",
...
function DataGridTableLoader() {
  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      <div className="flex items-center gap-2 border bg-card px-4 py-2 text-sm leading-none font-medium text-muted-foreground style-vega:rounded-lg style-nova:rounded-lg style-lyra:rounded-none style-maia:rounded-2xl style-mira:rounded-lg style-luma:rounded-3xl style-sera:rounded-none style-rhea:rounded-2xl">
...
function DataGridTableRowPin<TData extends object>({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex size-7 items-center justify-center text-muted-foreground transition-colors hover:text-foreground style-vega:rounded-md style-nova:rounded-lg style-lyra:rounded-none style-maia:rounded-full style-mira:rounded-md style-luma:rounded-full style-sera:rounded-none style-rhea:rounded-full",
    ...
    >
      {row.getCanExpand() ? (
        <button
          ...
          className={cn(
            "inline-flex items-center justify-center text-muted-foreground transition-colors hover:text-foreground style-vega:rounded-md style-nova:rounded-lg style-lyra:rounded-none style-maia:rounded-full style-mira:rounded-md style-luma:rounded-full style-sera:rounded-none style-rhea:rounded-full",
            controlSize
          )}
        >
          {children ?? (
