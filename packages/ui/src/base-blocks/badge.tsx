  ...
  ],
  {
    variants: {
      variant: {
        ...
        "invert-outline":
          "border-border bg-background text-invert dark:bg-input/30",
        "focus-outline":
      ...
      radius: {
        default:
          "style-vega:rounded-sm style-nova:rounded-sm style-lyra:rounded-none style-maia:rounded-4xl style-mira:rounded-sm style-luma:rounded-4xl style-sera:rounded-none style-rhea:rounded-2xl",
        full: "rounded-full",
      },
    },
    defaultVariants: {
