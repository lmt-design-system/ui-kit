...
const iconTileVariants = cva(
  ...
  ],
  {
    variants: {
      ...
      radius: {
        default:
          "[--icon-tile-radius:min(var(--radius-md),calc(var(--icon-tile-size)/3))] style-vega:[--icon-tile-radius:min(var(--radius-md),calc(var(--icon-tile-size)/3))] style-nova:[--icon-tile-radius:min(var(--radius-md),calc(var(--icon-tile-size)/3))] style-lyra:[--icon-tile-radius:0px] style-maia:[--icon-tile-radius:min(var(--radius-xl),calc(var(--icon-tile-size)/3))] style-mira:[--icon-tile-radius:min(var(--radius-md),calc(var(--icon-tile-size)/3))] style-luma:[--icon-tile-radius:min(var(--radius-xl),calc(var(--icon-tile-size)/4))] style-sera:[--icon-tile-radius:0px] style-rhea:[--icon-tile-radius:min(var(--radius-xl),calc(var(--icon-tile-size)/4))]",
