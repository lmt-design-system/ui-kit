  ...
  return (
    <InputGroup
      className={cn(
        ...
        context.size == "sm" &&
          "h-7! style-maia:h-8! style-mira:h-6! style-luma:h-8! style-sera:h-9!",
        context.size == "lg" &&
          "h-9! style-maia:h-10! style-mira:h-8! style-luma:h-10! style-sera:h-11!",
    ...
    >
      ...
      <InputGroupInput
        ...
        className={cn(
          context.size == "sm" &&
            "h-7! text-xs style-maia:h-8! style-mira:h-6! style-luma:h-8! style-sera:h-9!",
          context.size == "lg" &&
            "h-9! style-maia:h-10! style-mira:h-8! style-luma:h-10! style-sera:h-11!"
        )}
        {...props}
      ...
      {filters.map((filter) => {
        ...
        return (
          <ButtonGroup
            ...
            className="style-sera:*:rounded-none style-sera:*:border-transparent style-sera:*:border-b-input"
          >
            <ButtonGroupText>
