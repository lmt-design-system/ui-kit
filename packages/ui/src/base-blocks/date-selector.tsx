...
import {
  Calendar,
  CalendarDayButton,
} from "@ui-kit/ui/base-components/calendar"
          ...
          <div className="relative">
            ...
            {(inputHint ? inputValue : displayValue) && (
              <button
                ...
                className={cn(
                  // Base Styles
                  "absolute end-2.5 top-1/2 size-4 -translate-y-1/2 cursor-pointer style-vega:rounded-xs style-nova:rounded-xs style-lyra:rounded-none style-maia:rounded-full style-mira:rounded-xs style-luma:rounded-full style-sera:rounded-none style-rhea:rounded-full",
                  // Visual States
