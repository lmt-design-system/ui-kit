  ...
  return (
    <NumberFieldPrimitive.Decrement
      className={cn(
        ...
        "border-e-0 style-vega:rounded-s-md style-nova:rounded-s-lg style-lyra:rounded-s-none style-maia:rounded-s-4xl style-mira:rounded-s-md style-luma:rounded-s-3xl style-sera:rounded-s-none style-rhea:rounded-s-2xl",
        className
      )}
...
function NumberFieldIncrement({
  ...
  return (
    <NumberFieldPrimitive.Increment
      className={cn(
        numberFieldButtonVariants({ size }),
        "border-s-0 style-vega:rounded-e-md style-nova:rounded-e-lg style-lyra:rounded-e-none style-maia:rounded-e-4xl style-mira:rounded-e-md style-luma:rounded-e-3xl style-sera:rounded-e-none style-rhea:rounded-e-2xl",
        className
      )}
